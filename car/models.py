...
class Car(models.Model):
    ...
    transmission=models.CharField(choices=transmission_choice,max_length=150)
    interior=models.CharField(max_length=150)
    miles=models.IntegerField()
    doors=models.CharField(choices=door_choices,max_length=150)
    passengers=models.CharField(max_length=150)
    vin_no=models.CharField(max_length=150)
    milage=models.CharField(max_length=150)
